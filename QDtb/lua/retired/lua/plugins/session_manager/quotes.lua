...
local algorithm_quotes = {
  ...
  {
    text =
    'The best programs are the ones that are written by people who are thinking about the problem, not about the language.',
    source = 'Paul Graham'
  },
  {
...
function M.quotes()
  ...
  return {
    '',
    '  '' .. selected_quote.text .. '' - ' .. selected_quote.source,
    '',
  }
end
